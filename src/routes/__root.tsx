  ...
  head: () => ({
    meta: [
      ...
      { title: "Fraud Alert Room — Collaborative Fraud Detection Simulation" },
      {
        name: "description",
        content:
          "An interactive classroom role simulation where four fictional banks analyse local data and share fraud indicators to detect fraud together, demonstrating federated learning.",
      },
      { name: "author", content: "Sowmithra P | 24CS0923" },
      {
        property: "og:title",
        content: "Fraud Alert Room — Collaborative Fraud Detection Simulation",
      },
      {
